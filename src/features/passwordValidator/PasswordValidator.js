    ...
    <div className='conTop'>
      ...
      <div className="wrapper">
        ...
        <div className="box">
          ...
          <label style={{ fontWeight: 'bold', display: 'flex', justifyContent: 'center' }}>Please Enter Your Password</label>
          ...
          {lowerValidated && upperValidated && numberValidated && specialValidated &&
            lengthValidated &&
